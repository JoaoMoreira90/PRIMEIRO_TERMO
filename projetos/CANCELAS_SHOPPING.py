...
print("Ola você esta no shopping")
print("Qal e a forma que você quer para você ticket ou card")
print("se você tem a tag vc so precisa entrar e pagar na saida")